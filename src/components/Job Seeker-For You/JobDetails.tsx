...
const JobDetails = ({
    ...
    const [dialogType, setDialogType] = useState<"apply" | "report" | null>(
        null
    );
        ...
        >
            ...
            {similarJobs.length > 0 && (
                <div className="mb-6 pt-1 relative">
                    ...
                    <div className="flex items-center space-x-2">
                        <h3 className="text-lg font-semibold mb-6 pt-4">
                            Similar Jobs
                        </h3>
                    </div>
